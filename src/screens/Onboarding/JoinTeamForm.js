...
export default function JoinTeamForm({navigation, route}) {
      ...
      >
        <ScrollView style={{paddingHorizontal: 24, flex: 1}} contentContainerStyle={{paddingBottom: 20}}>
          <View style={{paddingTop: scale(96)}}>
            <H2 fontWeight={700}>Where do you work?</H2>
            <P fontWeight={300} style={{paddingTop: 12}}>This information will help us connect you with your team.</P>
          </View>
          <View style={styles.content}>
            <View style={styles.item}>
              <P fontWeight={400}>Business Name <P style={{color: color.primary}}>*</P></P>
        ...
        <View style={{paddingHorizontal: 24, paddingBottom: 24}}>
          <TouchableOpacity style={StyleSheet.flatten([styles.button])}>
            <P style={StyleSheet.flatten([styles.buttonText])}>Join Team</P>
          </TouchableOpacity>
        </View>
