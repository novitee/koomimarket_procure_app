      ...
      >
        <ScrollView style={{paddingHorizontal: 24, flex: 1}} contentContainerStyle={{paddingBottom: 20}}>
          <View style={{paddingTop: scale(96)}}>
            <H2 fontWeight={700}>Tell us about your business</H2>
            <P fontWeight={300} style={{paddingTop: 12}}>This information will help suppliers recognise the orders you send.</P>
          </View>
