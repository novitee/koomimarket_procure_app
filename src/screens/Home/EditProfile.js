...
export default function EditProfile({navigation, route}) {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      ...
      headerTitle: () => (
        <P fontWeight={600}>Edit Profile</P>
      ),
      headerRight: () => (
      ...
      <ScrollView style={{flex: 1}} contentContainerStyle={{paddingVertical: 20}}>
        <View style={{paddingVertical: 24, alignItems: "center"}}>
          <View style={styles.bigCircle}>
            <UserIcon color="rgba(156, 163, 175, 1)" />
        ...
        <View style={{paddingTop: 24}}>
          <View style={{paddingHorizontal: 24, paddingVertical: 4, borderTopWidth: 1, borderColor: color.border, borderBottomWidth: 1}}>
            <View style={{paddingVertical: 12}}>
              <P>zonghan@novitee.com</P>
            </View>
            <View style={{paddingVertical: 12, flexDirection: "row", justifyContent: "space-between", alignItems: "center"}}>
              <P>Mobile number</P>
              <P style={{color: "rgba(156, 163, 175, 1)"}}>91770500</P>
            </View>
          </View>
        </View>
      </ScrollView>
